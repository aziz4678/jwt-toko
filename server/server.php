...
include_once 'lib/php-jwt-5.5.1/src/BeforeValidException.php';
include_once 'lib/php-jwt-5.5.1/src/ExpiredException.php';
include_once 'lib/php-jwt-5.5.1/src/SignatureInvalidException.php';
include_once 'lib/php-jwt-5.5.1/src/JWT.php';
...
unset($abc,$postdata,$data,$data2,$data3,$token,$key,$issued_at,$expiration_time,$issuer,$jwt,$id_barang,$nama_barang,$stok_barang,$harga_satuan,$aksi,$e);
?>